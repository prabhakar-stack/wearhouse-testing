...
exports.RULES_BY_CASE = exports.ALL_ALERT_TYPES = exports.SOP_MAP = exports.ALERT_RULE_BY_TYPE = exports.ALERT_RULES = void 0;
// ─────────────────────────────────────────────────────────────────────────────
// ALERT RULES
// ─────────────────────────────────────────────────────────────────────────────
exports.ALERT_RULES = [
...
exports.ALERT_RULE_BY_TYPE = Object.fromEntries(exports.ALERT_RULES.map(function (r) { return [r.type, r]; }));
/** Quick lookup: alertType → SOP steps array (for use in /api/alerts/sop) */
exports.SOP_MAP = Object.fromEntries(exports.ALERT_RULES.map(function (r) { return [r.type, r.sopSteps]; }));
/** All unique alert type keys */
exports.ALL_ALERT_TYPES = exports.ALERT_RULES.map(function (r) { return r.type; });
/** Rules grouped by case for reporting/display */
exports.RULES_BY_CASE = exports.ALERT_RULES.reduce(function (acc, rule) {
    if (!acc[rule.case])
        acc[rule.case] = [];
